    ...
    return {
        ...
        execute: function() {
            EmpDetailService = (function () {
                function EmpDetailService(http) {
                    this.http = http;
                }
                EmpDetailService.prototype.fetchData = function () {
                    return this.http.get("./data/emp-details.json").map(function (res) { return res.json(); });
                };
