System.register(['@angular/core', '@angular/platform-browser', './app.component', './component.user.info', './component.user.info.form', '@angular/forms', './service.user.form.rules', './providers'], function(exports_1, context_1) {
    ...
    return {
        setters:[
            ...
            function (component_user_info_1_1) {
                component_user_info_1 = component_user_info_1_1;
            },
            function (component_user_info_form_1_1) {
                component_user_info_form_1 = component_user_info_form_1_1;
            },
            function (forms_1_1) {
                forms_1 = forms_1_1;
            },
